<template>
  <div class="services-page">
      ...
      <div class="container position-relative z-2 py-5">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <!-- Subtitle -->
            <p class="fs-5 text-white-50 mb-0 mx-auto" style="max-width: 680px;">
    ...
    <!-- ========================================
         INDUSTRY FOCUS — White background
         ======================================== -->
    <section class="py-5">
      <div class="container py-4">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mb-4">
            <h2 class="display-6 fw-bold mb-3">{{ $t('services.page.industryFocusTitle') }}</h2>
            <p class="fs-5 text-muted">{{ $t('services.page.industryFocusSubtitle') }}</p>
          </div>
          <div class="col-lg-8">
            <p class="fs-5 lh-lg mb-3 industry-body-text">
              {{ $t('services.page.industryFocusText1') }}
            </p>
            <p class="fs-5 lh-lg mb-3 industry-body-text">
              {{ $t('services.page.industryFocusText2') }}
            </p>
            <p class="fs-5 lh-lg mb-0 industry-body-text">
              {{ $t('services.page.industryFocusText3') }}
            </p>
          </div>
        </div>
      </div>
...
/* ================================
   INDUSTRY FOCUS — readable text
   ================================ */
.industry-body-text {
  color: #374151;
}

:global([data-bs-theme="dark"]) .industry-body-text {
  color: #d1d5db;
}
