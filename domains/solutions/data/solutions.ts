...
export const solutions: Solution[] = [
  {
    ...
    subtitle: 'AI-powered risk models, data modernization, and regulatory compliance',
    ...
    testimonial: {
      quote: 'Gamma Neutral transformed our risk management capabilities. We now detect potential issues 60% faster and have reduced false positives by 40%.',
      author: 'Sarah Chen',
  ...
  },
  {
    ...
    title: 'Healthcare',
    subtitle: 'Health data interoperability, patient analytics, and PHIPA-compliant architectures',
  ...
  },
  {
    ...
    subtitle: 'Secure cloud, data modernization, and evidence-based analytics',
