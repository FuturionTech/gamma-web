  ...
  <main class="policy-content">
    ...
    <section id="contact" class="policy-section">
      ...
      <p>
        ...
        Email: <a :href="company.mailtoHref">{{ company.email }}</a>
      </p>
      <p>
      ...
      <p>
        <strong>Email:</strong> <a :href="company.mailtoHref">{{ company.email }}</a><br>
        <strong>Mail:</strong> {{ company.address.full }}
      </p>
